                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a href="#" tabindex="-1" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{url('forum/threads')}}">All threads</a></li>
                                @if(auth()->check())
                                <li><a href="{{url('/forum/threads?by='. Auth::user()->name)}}">My threads</a></li>
                                    @endif
                                    <li><a href="{{url('forum/threads?popular=1')}}">Popular threads</a></li>
                                </ul>
                            ...
                            <a href="#" tabindex="-2" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">Channels</a>
                                ...
                                @foreach($channels as $channel)
                                    <li><a href="{{url('/forum/threads/'.$channel->slug)}}">{{$channel->name}}</a></li>
                                @endforeach

                            </ul>
                        </li>
                        @if(auth()->check())
                        <li class="list-group-item"><a href="{{url('forum/threads/create')}}">Create Thread</a></li>
                        @endif
                        </ul>
